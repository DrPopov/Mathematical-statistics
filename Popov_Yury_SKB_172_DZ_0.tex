...
\begin{center}
	\begin{minipage}[h]{0.4\linewidth}
		\center{\includegraphics[width=1\linewidth]{ex_1_16.jpg} \\ Рис.3 n = 1000000}
	\end{minipage}
\end{center}
...
\vspace{5mm}
\begin{minipage}[h]{0.4\linewidth}
	\center{\includegraphics[width=2.5\linewidth]{ex_time_1.jpg} \\ }
\end{minipage}
\vspace{5mm}

\vspace{5mm}
\begin{minipage}[h]{0.4\linewidth}
	\center{\includegraphics[width=2.5\linewidth]{ex_time_2.jpg} \\ }
\end{minipage}
\vspace{5mm}
...
\begin{center}
	\begin{minipage}[h]{0.4\linewidth}
		\center{\includegraphics[width=1\linewidth]{py1_16.jpg} \\  n = 1000000}
	\end{minipage}
\end{center}
...
\begin{center}
	\begin{minipage}[h]{0.4\linewidth}
		\center{\includegraphics[width=1\linewidth]{py_2_16.jpg} \\ n = 1000000}
	\end{minipage}
\end{center}
...
\begin{center}
	\begin{minipage}[h]{0.4\linewidth}
		\center{\includegraphics[width=1\linewidth]{py_3_16.jpg} \\ n = 1000000}
	\end{minipage}
\end{center}
...
\vspace{5mm}
\begin{minipage}[h]{0.4\linewidth}
	\center{\includegraphics[width=2.5\linewidth]{time_1.jpg} \\ }
\end{minipage}
\vspace{5mm}

\vspace{5mm}
\begin{minipage}[h]{0.4\linewidth}
	\center{\includegraphics[width=2.5\linewidth]{time_2.jpg} \\ }
\end{minipage}
\vspace{5mm}

\vspace{5mm}
\begin{minipage}[h]{0.4\linewidth}
	\center{\includegraphics[width=2.5\linewidth]{time_3.jpg} \\ }
\end{minipage}
\vspace{5mm}

\vspace{5mm}
\begin{minipage}[h]{0.4\linewidth}
	\center{\includegraphics[width=2.5\linewidth]{time_4.jpg} \\ }
\end{minipage}
\vspace{5mm}
