...
\vspace{5mm}
\text{\large{\textbf {2.3.1 Геометрическое распределение}}}\\
\addcontentsline{toc}{section}{2.3.1 Геометрическое распределение}
\vspace{5mm}
...
\begin{figure}[h!]
	\begin{center}
		\begin{minipage}[h]{0.47\linewidth}
			\center{\includegraphics[width=1\linewidth]{fotos/Gist/geom_gist_5.png}} a) \\
		\end{minipage}
		\hfill
		\begin{minipage}[h]{0.47\linewidth}
			\center{\includegraphics[width=1\linewidth]{fotos/Gist/geom_gist_10.png}} \\b)
		\end{minipage}
		\vfill
		\begin{minipage}[h]{0.47\linewidth}
			\center{\includegraphics[width=1\linewidth]{fotos/Gist/geom_gist_100.png}} c) \\
		\end{minipage}
		\hfill
		\begin{minipage}[h]{0.47\linewidth}
			\center{\includegraphics[width=1\linewidth]{fotos/Gist/geom_gist_1000.png}} d) \\
		\end{minipage}
		\hfill
		\begin{minipage}[h]{0.47\linewidth}
			\center{\includegraphics[width=1\linewidth]{fotos/Gist/geom_gist_103.png}} e) \\
			\vspace{10mm}
		\end{minipage}
	\end{center}
\end{figure}
...
\begin{figure}[h!]
	\begin{center}
		\begin{minipage}[h]{0.47\linewidth}
			\center{\includegraphics[width=1\linewidth]{fotos/Poligon/geom_polig_5.png}} a) \\
		\end{minipage}
		\hfill
		\begin{minipage}[h]{0.47\linewidth}
			\center{\includegraphics[width=1\linewidth]{fotos/Poligon/geom_polig_10.png}} \\b)
		\end{minipage}
		\vfill
		\begin{minipage}[h]{0.47\linewidth}
			\center{\includegraphics[width=1\linewidth]{fotos/Poligon/geom_polig_100.png}} c) \\
		\end{minipage}
		\hfill
		\begin{minipage}[h]{0.47\linewidth}
			\center{\includegraphics[width=1\linewidth]{fotos/Poligon/geom_polig_1000.png}} d) \\
		\end{minipage}
		\hfill
		\begin{minipage}[h]{0.47\linewidth}
			\center{\includegraphics[width=1\linewidth]{fotos/Poligon/geom_polig_103.png}} e) \\
			\vspace{50mm}
		\end{minipage}
	\end{center}
\end{figure}
