...
Для каждой выборки из домашнего задания 2 объема 5 и 10 посчитаем выборочное среднее и выборочную дисперсию. Для наглядности выведем вариационный ряд и посчитанные оба параметра.
